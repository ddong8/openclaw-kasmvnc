...
./openclaw-kasmvnc.sh install              # 安装
./openclaw-kasmvnc.sh uninstall            # 卸载（仅停服务）
./openclaw-kasmvnc.sh uninstall --purge    # 卸载并删除安装目录
./openclaw-kasmvnc.sh restart              # 重启
./openclaw-kasmvnc.sh upgrade              # 升级
./openclaw-kasmvnc.sh status               # 状态
./openclaw-kasmvnc.sh logs --tail 200      # 日志
```
...
- `openclaw-kasmvnc.sh` — macOS/Linux 管理脚本
- `openclaw-kasmvnc.ps1` — Windows 管理脚本
